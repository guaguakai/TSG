...
if __name__ == "__main__":
    ...
    pickle.dump((obj_relax, obj_yn, obj_final, time_relax, time_yn, time_final), open("resultsDifferentDistr_q_0125.data", "wb"))
    # obj_relax, obj_yn, obj_final, time_relax, time_yn, time_final = pickle.load(open("resultsDifferentDistr_q_0125.data", "rb"))