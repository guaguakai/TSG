...
if __name__ == "__main__":
    ...
    # ======================= file storage ==========================
    f_q = open("exp/exp1/exp1_0131_2000.csv", "a")
    f_cg = open("exp/exp3/exp3_cg_0131_2000.csv", "a")
    ...
    for i in range(iterations):
        ...
        tmp_obj_cg, tmp_time_cg, tmp_iterations_cg, tmp_all_objectives, tmp_all_k_objectives, tmp_all_times = column.columnGeneration(W, K, R, mR, M, P, teams, resource2team, T, E, C, U_plus, U_minus, N_wk, shift, mr, ar, phi, 1, maxT, column_generation_iterations=1000, warm_start=False)
